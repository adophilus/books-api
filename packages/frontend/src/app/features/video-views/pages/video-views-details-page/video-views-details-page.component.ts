...
@Component({
  selector: "app-video-views-details-page",
  standalone: true,
  imports: [CommonModule],
  templateUrl: "./video-views-details-page.component.html",
})
export class VideoViewsDetailsPageComponent implements OnInit {
  videoView: VideoView | null = null;
  isLoading = false;
  hasError = false;
  ...
  ngOnInit(): void {
    ...
    this.service.selectById(id).subscribe({
      next: (v) => { this.videoView = v; this.isLoading = false; },
